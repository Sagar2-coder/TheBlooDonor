                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-col gap-4">
                            <Button
                                ...
                                onClick={() => {
                                    if (!providers.google) {
                                        toast({ title: "Not Available", description: "Google login is not configured yet. Please add GOOGLE_CLIENT_ID and GOOGLE_CLIENT_SECRET to the .env file.", variant: "destructive" });
                                        return;
                                    }
